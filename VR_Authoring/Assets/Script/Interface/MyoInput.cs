...
public class MyoInput: GestureInput {
    ...
    public override bool Next() { if (isReady) return myo.currentGesture == MyoGesture.Gesture.DOUBLE_TAP; else return false; }
    ...
    public override bool Cancel() { if (isReady) return myo.currentGesture == MyoGesture.Gesture.FIST_HOLD; else return false; }
}
